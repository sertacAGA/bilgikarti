...
image: "images/05.jpg",
options: {
A: "Yes, remains have been found.",
B: "No, they only appear in legends.",
C: "Science has definitively proven it.",
D: "It is believed that they still live in some regions."
},
correctAnswer: "B",
...
C: "Chinese court culture",
D: "South American Native Americans"
},
correctAnswer: "A",
...
image: "images/13.jpg",
options: {
A: "It looks too green",
B: "It needs to be eaten raw",
C: "Its bitter taste and smell",
D: "It's hard"
},
correctAnswer: "C",
...
D: "Genocide committed by Israel against the Palestinian people"
},
correctAnswer: "D",
...
image: "images/20.jpg",
options: {
A: "To teach tactics to soldiers",
B: "To entertain the nobility",
C: "To write laws",
...
options: {
A: "Their large tails",
B: "Their ability to sing underwater",
C: "Their scaly skin",
...
image: "images/23.jpg",
options: {
A: "Their extendable necks",
B: "Their very long arms",
C: "Their ability to fly",
D: "Their ability to live in cold climates"
},
correctAnswer: "B",
...
image: "images/24.jpg",
options: {
A: "Because they were discovered in Egypt",
B: "Because they change color in the sun",
C: "Because their appearance resembles the Sphinx statue in Ancient Egypt",
D: "Because their fur sheds later"
},
correctAnswer: "C",
...
options: {
A: "They like to live alone",
B: "They run very slowly",
C: "They are only active at night",
D: "They act with pack instinct"
},
correctAnswer: "D",
...
function updateUITexts() {
    ...
    // Global değişkenleri tekrar bağla (innerHTML değiştiği için referans kopabilir)
    // Ancak burada sadece text node değişmediği için span ID'leri ile oynama riskine girmeyelim,
    // basitçe üstteki ID'leri tekrar yakalamaya gerek yok, loadCard içinde güncelliyoruz zaten.
